      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          {url.map((link, index) => (
            <a
              key={index}
              className={`inline-flex items-center font-medium text-${urlColor}-400 hover:text-${urlColor}-800 transition-colors duration-200 underline-offset-2 hover:underline ml-1`}
              href={link}
            >
              {urlMsg[index] || ""}
            </a>
